...
* @returns {Uint8Array}
*/
__exports.convimg = function(input_img, filters_checkbox, filter_params_js) {
    try {
        var ret = wasm.convimg(addHeapObject(input_img), addBorrowedObject(filters_checkbox), addBorrowedObject(filter_params_js));
